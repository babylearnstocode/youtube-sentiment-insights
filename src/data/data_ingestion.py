...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    ...
    try:
        ...
        logger.info("Train and test data saved successfully in %s.", raw_data_path)
    except Exception as e:
...
def main():
    try:
        ...
        train_data, test_data = train_test_split.train_test_split(final_df, test_size=test_size, random_state=42)
